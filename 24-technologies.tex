...
\cline{2-7}
\multicolumn{1}{l|}{} & 
\multicolumn{3}{c|}{Verbindung} & 
RR & 
\multicolumn{2}{c|}{Anfragen} 
\\

\cline{2-7} 
\multicolumn{1}{l|}{} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Integrität \\ der Nachrichten \end{tabular}} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Authentizität \\ des Resolvers \end{tabular}} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Vertraulichkeit \\ der Verbindung \end{tabular}} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Authentizität \\ der Antwort \end{tabular}} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Vertraulichkeit \\ der Anfrage am Resolver \end{tabular}} & 
\rotatebox[origin=c]{90}{\begin{tabular}[c]{c}Vertraulichkeit \\ der Anfrage am auth. DNS \end{tabular}} 
\\ 

\hline
\multicolumn{1}{|r|}{DNS}           & N          & N             & N               & N             & N                          & N                           \\ 
\hline
\multicolumn{1}{|r|}{DNSSEC}        & Y          & N*             & N               & Y             & N                          & N                           \\ 
\hline
\multicolumn{1}{|r|}{DNSCurve}      & Y          & Y*            & Y               & N             & Y                          & N                           \\ 
\hline
\multicolumn{1}{|r|}{DNSCrypt}      & Y          & Y             & Y               & N             & N                          & N                           \\ 
\hline
\multicolumn{1}{|r|}{DoT / DoH}     & Y          & Y             & Y               & N             & N                          & N                           \\ 
\hline
\multicolumn{1}{|r|}{QNAME min.}    & N          & N             & N               & N             & N                          & Y*                          \\ 
\hline
\multicolumn{1}{|r|}{EncDNS / ODNS} & Y          & Y             & Y               & N             & Y                          & N                           \\ 
\hline
\end{tabular}
\end{table}