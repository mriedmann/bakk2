...
Abgesehen von der Verfügbarkeit des DNS selbst, wird es, wie in Abschnitt \ref{sec:Thread-DosAmp} und \ref{sec:sec:attack-dosamp} beschrieben, auch selbst als Verstärker (Traffic amplification; DoS amplification attack) für DoS-Attacken eingesetzt. Es ist daher für zum Schutz anderer Internet-Services essenziell, dass DNS und dessen Implementierungen nicht lohnender für Traffic-Amplification Versuche sind als andere Services. 
