...
\usepackage[inlineFootnotes,citations,fencedCode,definitionLists,hashEnumerators,smartEllipses,hybrid]{markdown}
...
\newenvironment{draft}
{\par
  \begin{tcolorbox}[title=Entwurfstext,breakable,boxrule=0pt]
}{\par
  \end{tcolorbox}
}
...
\include{10-intro/relatedwork}

\include{20-work/threads}

\include{20-work/attacks}

\include{20-work/goals}
